    ...
    <div>
      <>
        ...
        <footer className="footer">
              ...
              <div className="row gy-4 gy-lg-0">
                <div className="col-12 col-sm-6 col-md-3 col-lg-2">
                  <div className="widget">
                    <h4 className="widget">Hobbycue</h4>
                ...
                <div className="col-12 col-sm-6 col-md-3 col-lg-2">
                  <div className="widget">
                    <h4 className="widget-title mb-4">How Do I</h4>
                    <ul className="list-unstyled">
                      <li className="mb-2">
                        <a
                          href="#!"
                ...
                <div className="col-12 col-lg-4">
                  <div className="widget">
                    <h4 className="widget-title mb-4">Social media</h4>
                    ...
                    <h4 className="widget-title mb-4  w-5">Invite friends</h4>
                    <form action="#!">
                      <div className="row gy-4">
                        <div className="col-12">
                          <div className="input-group">
                            <Form className="col-12 d-flex float-right">
                              <FormControl
                                type="search"
          ...
          <div className="bg-purple py-4 py-md-5 py-xl-8 border-top border-light-subtle">
            <div className="container overflow-hidden">
